  ...
  export default {
    ...
    methods: {
        initScene() {
            ...
            this.scene.background = new THREE.Color(0xe7f7c8);
      ...
      loadObj() {
        ...
        loader.load(
            ...
            (object) => {
                ...
                this.camera.position.x += size / 2.5;  // Adjust this value as needed
                this.camera.position.y += size / 2.5;  // Adjust this value as needed
                this.camera.position.z += size / 2.5;  // Adjust this value as needed
