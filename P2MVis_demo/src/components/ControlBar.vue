  ...
  <div class="controlbar">
    ...
    <div class="top-panel">
      ...
      <div id="timeline-controls" class="top-panel-item">
        <!--     重启按钮-->
        <button id="reset-button" title="Reset the model">
          <img class="material-icons" id="button-top-reset" src="/chehuinew.svg" />
        </button>
        <!--    启动/暂停按钮-->
        <button id="play-pause-button" title="Run/Pause training" @click="togglePlayPause">
        ...
        <button id="edit-button" title="edit the config" @click="updateVisiable">
