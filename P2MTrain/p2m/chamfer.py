...
nn_distance_module = tf.load_op_library('/home/giga/Desktop/davistao/p2m_tf2/Pixel2Mesh-Tensorflow2/external'
                                        '/tf_nndistance_so.so')
...
output: idx2:  (batch_size,#point_2)   nearest neighbor from second to first
    """
    # ex:dim[1,1,3]->dim[1,1,1,3]  注意是维度，不是矩阵值
    xyz1 = tf.expand_dims(xyz1, axis=0)
    xyz2 = tf.expand_dims(xyz2, axis=0)
    xyz1 = tf.cast(xyz1, dtype=tf.float32)
