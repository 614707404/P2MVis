...
class ZipCreator(object):
    def __init__(self, name='', precision=8, overlay=None, output_dir='/home/giga/Desktop/davistao/the_lab/the_lab/public'):
        # self.file = os.path.abspath(file)
        self.out_file = os.path.join(output_dir, '{}.{}.zip'.format(name, precision))
        self.name = name
